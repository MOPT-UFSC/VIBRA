...
def load_external_mesh_and_solve(distributed_mass: bool=False):
    ...
    results_path = PROJECT_DIR / "validation_files/data/WB/structural/elements_integration/hex20/results/modal"
    if distributed_mass:
