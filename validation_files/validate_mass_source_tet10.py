...
def load_external_mesh_and_solve(assignment_type: str):
    ...
    mesh_path = "validation_files/data/WB/mass_source/mesh/ds_mass_source_tet10.dat"
    ...
    mesh.external_connectivity_from_lines[line_id] = np.array([[86, 116, 2516], [116, 115, 2713], [115, 114, 2705], [114, 28, 2128]], dtype=int) - 1
