...
def load_external_mesh_and_solve(integration_type: str):
    ...
    mesh_path = PROJECT_DIR / "validation_files/data/WB/structural/elements/tet4/mesh/ds_tet4_tetrahedron_modal.dat"
    ...
    results_path = PROJECT_DIR / "validation_files/data/WB/structural/elements/tet4/results/modal/"
