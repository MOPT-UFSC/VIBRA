...
class Project:
    ...
    def set_thermoviscous_stinson_model(self, data, **kwargs):
        self.model.set_thermoviscous_stinson_model_data(data, **kwargs)
    ...
    def solve_acoustic_harmonic_analysis(self):
        ...
        self.model.process_thermoviscous_stinson_properties(self.analysis_data["frequencies"])
        self.acoustic_assembler.process_assemble()
