...
class STRUCT_HEXAHEDRON_20:
    ...
    def reorder_connect(self):
        ...
        self.connectivity = self.connectivity[:, [0, 4, 5, 6, 7, 8, 9, 10, 11, 12, 15, 17, 13, 20, 22, 23, 21, 14, 16, 18, 19]]
    ...
    def generate_ind_rows_cols(self):
        ...
        ind_dofs = (np.array([  dofs*self.connectivity[:,1] - 1 , dofs*self.connectivity[:,1] , dofs*self.connectivity[:,1] + 1 ,
                                ...
                                dofs*self.connectivity[:,4] - 1 , dofs*self.connectivity[:,4] , dofs*self.connectivity[:,4] + 1 ,
                                dofs*self.connectivity[:,5] - 1 , dofs*self.connectivity[:,5] , dofs*self.connectivity[:,5] + 1 ,
                                dofs*self.connectivity[:,6] - 1 , dofs*self.connectivity[:,6] , dofs*self.connectivity[:,6] + 1 ,
                                dofs*self.connectivity[:,7] - 1 , dofs*self.connectivity[:,7] , dofs*self.connectivity[:,7] + 1 ,
                                dofs*self.connectivity[:,8] - 1 , dofs*self.connectivity[:,8] , dofs*self.connectivity[:,8] + 1 ,
                                dofs*self.connectivity[:,9] - 1 , dofs*self.connectivity[:,9] , dofs*self.connectivity[:,9] + 1 ,
                                dofs*self.connectivity[:,10] - 1, dofs*self.connectivity[:,10], dofs*self.connectivity[:,10] + 1,
                                dofs*self.connectivity[:,11] - 1, dofs*self.connectivity[:,11], dofs*self.connectivity[:,11] + 1,
                                dofs*self.connectivity[:,12] - 1, dofs*self.connectivity[:,12], dofs*self.connectivity[:,12] + 1,
                                dofs*self.connectivity[:,13] - 1, dofs*self.connectivity[:,13], dofs*self.connectivity[:,13] + 1,
                                dofs*self.connectivity[:,14] - 1, dofs*self.connectivity[:,14], dofs*self.connectivity[:,14] + 1,
                                dofs*self.connectivity[:,15] - 1, dofs*self.connectivity[:,15], dofs*self.connectivity[:,15] + 1,
                                dofs*self.connectivity[:,16] - 1, dofs*self.connectivity[:,16], dofs*self.connectivity[:,16] + 1,
                                dofs*self.connectivity[:,17] - 1, dofs*self.connectivity[:,17], dofs*self.connectivity[:,17] + 1,
                                dofs*self.connectivity[:,18] - 1, dofs*self.connectivity[:,18], dofs*self.connectivity[:,18] + 1,
                                dofs*self.connectivity[:,19] - 1, dofs*self.connectivity[:,19], dofs*self.connectivity[:,19] + 1,
                                dofs*self.connectivity[:,20] - 1, dofs*self.connectivity[:,20], dofs*self.connectivity[:,20] + 1  ], dtype=int) + 1).T
