...
class StructuralAssembler:
    ...
    def get_data_to_process_global_matrices(self):
        ...
        self.active_2d_element_dofs, self.total_dofs, shift_index = self.process_face_elements_with_thickness(self.element_2d, self.element_3d)
    ...
    def assemble_global_matrices(self):
        ...
        _stiffness_matrix_full = csr_matrix((self.data_K, (self.ind_rows, self.ind_cols)), shape=(self.total_dofs, self.total_dofs))
        _mass_matrix_full = csr_matrix((self.data_M, (self.ind_rows, self.ind_cols)), shape=(self.total_dofs, self.total_dofs))
