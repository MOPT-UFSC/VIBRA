...
class ModelSetupItems(CommonMenuItems):
    ...
    def _create_items(self):
        ...
        self.item_child_advanced_element_options = self.add_item("Advanced Element Options")
        ...
        self.property_names = {
            ...
            "item_child_advanced_element_options": "advanced_element_options",
    ...
    def _initial_configuration(self):
        ...
        self.item_child_advanced_element_options.setDisabled(True)
    ...
    def item_child_advanced_element_options_callback(self):
    ...
    def modify_general_settings_items_access(self, key: bool):
        ...
        self.item_child_advanced_element_options.setDisabled(not imported_geometry)
