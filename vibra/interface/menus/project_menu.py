...
class ProjectMenu(QMenu):
    ...
    def exit_callback(self):
        loaded_function = load_function(self.main_window.project.long_function, self)
        loaded_function()
    ...
    def show_model_callback(self):
        self.main_window.viewer_tabs.show_model()
    ...
    def solve_example_analisys_callback(self):
        # self.main_window.project.example_solver.solve()
