...
from vibra.interface.viewer_3d.actors.deformed_solids_actor import DeformedSolidsActor


class DeformedAnalysisActor(DeformedSolidsActor):
    def __init__(self, mesh, results):
        super().__init__(mesh, results)
