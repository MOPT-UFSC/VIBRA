...
from vibra.interface.ui_generated.plots.acoustic.plot_particle_velocity_frequency_response_input_ui import PlotParticleVelocityFrequencyResponseInput_UI
...
class PlotParticleVelocityFrequencyResponseInput(PlotParticleVelocityFrequencyResponseInput_UI):
