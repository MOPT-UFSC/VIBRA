from PyQt5.QtWidgets import QDialog, QSlider, QSpinBox, QPushButton
...
class SectionPlaneWidget(QDialog):
    ...
    def _create_connections(self):
        ...
        #
        self.relative_plane_position_x_spinbox.valueChanged.connect(self.spinbox_value_change_callback)
        self.relative_plane_position_y_spinbox.valueChanged.connect(self.spinbox_value_change_callback)
    ...
    def get_rotation(self, get_from : str):
        if get_from == "sliders":
