...
from vibra.interface.ui_generated.analysis.user_defined_frequencies_input_ui import UserDefinedFrequenciesInput_UI
...
class UserDefinedFrequenciesSelectorInput(UserDefinedFrequenciesInput_UI):
    ...
    def load_analysis_setup(self):
        ...
        for index, freq in enumerate(self.table_frequencies):
            ...
            self.tableWidget_frequencies.setCellWidget(index, 2, checkbox_conteiner)
    ...
    def set_enabled_frequencies_checked(self):
        ...
        for index, tab_freq in enumerate(self.table_frequencies):
            is_freq_active = tab_freq in self.model.frequencies
