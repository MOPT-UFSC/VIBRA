...
GLOBAL_SHORTCUTS = {
    ...
    "Ctrl+E": "action_export_mesh_callback",
    "Ctrl+P": "copy_screenshot_to_clipboard",
    "Ctrl+D": "reset_solution_shortcut",
    "Ctrl+N": "action_new_project_callback",
    "Ctrl+W": "action_home_exit_callback",
