...
#
from vibra.interface.general.call_double_confirmation_input2 import CallDoubleConfirmationInput
...
class FluidInput(QDialog):
    ...
    def check_compressor_inputs(self):
        if self.compressor_thermodynamic_state:
            ...
            self.radioButton_all_bodies.setDisabled(True)
