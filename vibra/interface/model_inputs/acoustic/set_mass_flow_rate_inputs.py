...
from vibra.interface.ui_generated.model.setup.acoustic.mass_flow_rate_input_ui import MassFlowRateInput_UI
...
class MassFlowRateInput(MassFlowRateInput_UI):
