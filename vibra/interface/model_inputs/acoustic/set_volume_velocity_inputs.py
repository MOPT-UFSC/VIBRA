...
class VolumeVelocityInput(QDialog):
    ...
    def _define_qt_variables(self):
        ...
        self.tab_constant_values = self.tabWidget_volume_velocity.findChild(
            QWidget, "tab_constant_values"
        )
        self.tab_table_values = self.tabWidget_volume_velocity.findChild(
    ...
    def remove_bc_from_selection(self):
        if self.lineEdit_selection_id.text() != "":
            ...
            if picked_id in self.properties.surfaces_with_volume_velocity.keys():
                ...
                message = (
                    f"The volume velocity attributed to the {picked_id} surface has been removed."
                )
