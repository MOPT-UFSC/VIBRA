...
class AcousticPressureInputs(AcousticPressureInputs_UI):
    ...
    def _create_connections(self):
        ...
        self.treeWidget_acoustic_pressure.itemClicked.connect(self.item_clicked_callback)
        self.treeWidget_acoustic_pressure.itemDoubleClicked.connect(self.item_double_clicked_callback)
    ...
    def constant_data_assignment(self, surface_ids: list[int]):
        ...
        acoustic_pressure = self.check_input_entries(
        ...
        if acoustic_pressure.count(None) == 2:
        ...
        left_values = [acoustic_pressure[0]]
        right_values = [acoustic_pressure[1]]
    ...
    def remove_callback(self):
        ...
        for item in selected_items:
            ...
            if selection == "surface":
                self.properties._remove_surface_property("acoustic_pressure", selected_id)
