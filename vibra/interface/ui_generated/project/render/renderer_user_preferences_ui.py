...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.setMinimumSize(QSize(480, 480))
        ...
        self.frame_6.setMinimumSize(QSize(240, 80))
        ...
        self.gridLayout_14.addWidget(self.checkBox_reference_scale, 0, 0, 1, 1)
        ...
        self.frame_background_color_2.setMinimumSize(QSize(320, 42))
        ...
        self.pushButton_edges_color.setMinimumSize(QSize(90, 26))
        self.pushButton_edges_color.setMaximumSize(QSize(90, 26))
        self.pushButton_edges_color.setFont(font3)
        ...
        self.label_9.setMinimumSize(QSize(160, 32))
        self.label_9.setMaximumSize(QSize(160, 32))
        ...
        self.gridLayout_20.addWidget(self.label_3, 9, 3, 1, 1)
        ...
        self.lineEdit_edges_color.setAlignment(Qt.AlignCenter)
        ...
        self.lineEdit_faces_color.setAlignment(Qt.AlignCenter)
        ...
        self.pushButton_faces_color.setMinimumSize(QSize(90, 26))
        self.pushButton_faces_color.setMaximumSize(QSize(90, 26))
        font5 = QFont()
        font5.setFamilies([u"Arial"])
        font5.setPointSize(8)
        self.pushButton_faces_color.setFont(font5)
        ...
        self.spinBox_renderer_font_size.setMinimum(8)
        self.spinBox_renderer_font_size.setMaximum(15)
        self.spinBox_renderer_font_size.setValue(12)

        self.gridLayout_20.addWidget(self.spinBox_renderer_font_size, 9, 2, 1, 1)
