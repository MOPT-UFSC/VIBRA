...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon = Icon(u":/logos/circles/vibra_circle_colored_other_background.png")
        ...
        self.gridLayout_3.setContentsMargins(-1, 24, -1, 0)
        self.label = QLabel(self.frame_main)
        self.label.setObjectName(u"label")
        sizePolicy.setHeightForWidth(self.label.sizePolicy().hasHeightForWidth())
        self.label.setSizePolicy(sizePolicy)
        self.label.setMinimumSize(QSize(440, 100))
        self.label.setMaximumSize(QSize(440, 100))
        font1 = QFont()
        ...
        self.label.setPixmap(QPixmap(u":/logos/vibra_colored_dark_background.png"))
