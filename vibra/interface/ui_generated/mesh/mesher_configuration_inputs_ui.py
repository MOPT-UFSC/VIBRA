...
################################################################################
## Form generated from reading UI file 'mesher_configuration_inputs.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.comboBox_evaluate_mesh_quality_metrics = QComboBox(self.frame_element_formulation)
        self.comboBox_evaluate_mesh_quality_metrics.addItem("")
        self.comboBox_evaluate_mesh_quality_metrics.addItem("")
        self.comboBox_evaluate_mesh_quality_metrics.setObjectName(u"comboBox_evaluate_mesh_quality_metrics")
        self.comboBox_evaluate_mesh_quality_metrics.setMinimumSize(QSize(120, 28))
        self.comboBox_evaluate_mesh_quality_metrics.setMaximumSize(QSize(140, 16777215))
        font = QFont()
        font.setPointSize(10)
        self.comboBox_evaluate_mesh_quality_metrics.setFont(font)

        self.gridLayout_2.addWidget(self.comboBox_evaluate_mesh_quality_metrics, 2, 2, 1, 1)
        ...
        self.checkBox_mesh_connection = QCheckBox(self.frame_element_formulation)
        ...
        self.gridLayout_2.addWidget(self.checkBox_mesh_connection, 4, 1, 1, 2)
        ...
        self.comboBox_nodes_from_connected_volumes = QComboBox(self.frame_element_formulation)
        self.comboBox_nodes_from_connected_volumes.addItem("")
        self.comboBox_nodes_from_connected_volumes.addItem("")
        self.comboBox_nodes_from_connected_volumes.setObjectName(u"comboBox_nodes_from_connected_volumes")
        self.comboBox_nodes_from_connected_volumes.setMinimumSize(QSize(120, 28))
        self.comboBox_nodes_from_connected_volumes.setMaximumSize(QSize(140, 16777215))
        self.comboBox_nodes_from_connected_volumes.setFont(font)

        self.gridLayout_2.addWidget(self.comboBox_nodes_from_connected_volumes, 3, 2, 1, 1)
        ...
        self.doubleSpinBox_size_factor.setValue(0.100000000000000)
        ...
        self.gridLayout_10.addWidget(self.pushButton, 1, 4, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.comboBox_evaluate_mesh_quality_metrics.setItemText(0, QCoreApplication.translate("Dialog", u"No", None))
        self.comboBox_evaluate_mesh_quality_metrics.setItemText(1, QCoreApplication.translate("Dialog", u"Yes", None))
        ...
        self.label_19.setText(QCoreApplication.translate("Dialog", u"Evaluate mesh quality metrics:", None))
        self.label_20.setText(QCoreApplication.translate("Dialog", u"Nodes from connected volumes:", None))
        self.comboBox_nodes_from_connected_volumes.setItemText(0, QCoreApplication.translate("Dialog", u"Merge", None))
        self.comboBox_nodes_from_connected_volumes.setItemText(1, QCoreApplication.translate("Dialog", u"Independent", None))
        ...
        self.label.setText(QCoreApplication.translate("Dialog", u"Mesher configuration", None))
...
class MesherConfigurationInputs_UI(QDialog, Ui_Dialog):
    """
    Component Hierarchy:
    - Dialog: QDialog
        - (Layout): QGridLayout
                - frame_main: QFrame
                    - (Layout): QGridLayout
                            - frame_element_formulation: QFrame
                                - (Layout): QGridLayout
                                        - comboBox_evaluate_mesh_quality_metrics: QComboBox
                                        ...
                                        - label_19: QLabel
                                        - label_20: QLabel
                                        - comboBox_nodes_from_connected_volumes: QComboBox
