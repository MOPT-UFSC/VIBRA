...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.frame_middle.setMaximumSize(QSize(160, 350))
        ...
        self.lineEdit_composition = QLineEdit(self.frame_middle)
        ...
        self.label_6 = QLabel(self.frame_middle)
...
"QLineEdit:disabled{color: rgb(100, 100, 100); background-color: rgb(240, 240, 240)}")
        ...
        QWidget.setTabOrder(self.lineEdit_fluid_name, self.lineEdit_temperature)
