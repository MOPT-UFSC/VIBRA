...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButton_attribute.setMaximumSize(QSize(140, 32))
        font = QFont()
        ...
        self.pushButton_exit.setMaximumSize(QSize(140, 32))
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_attribute.setText(QCoreApplication.translate("Form", u"Attribute fluid", None))
#if QT_CONFIG(tooltip)
