...
################################################################################
## Form generated from reading UI file 'constrained_dof_inputs.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.pushButton_fixed_support.setMaximumSize(QSize(100, 28))
        ...
        self.gridLayout_3.addWidget(self.pushButton_fixed_support, 0, 1, 1, 1)

        self.pushButton_unselect_all = QPushButton(self.frame_9)
        self.pushButton_unselect_all.setObjectName(u"pushButton_unselect_all")
        self.pushButton_unselect_all.setMinimumSize(QSize(100, 28))
        self.pushButton_unselect_all.setMaximumSize(QSize(100, 28))
        ...
        self.gridLayout_3.addWidget(self.pushButton_unselect_all, 0, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBox_constrain_rz, 4, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBox_constrain_uy, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBox_constrain_uz, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBox_constrain_rx, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBox_constrain_ry, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBox_constrain_ux, 2, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(QCoreApplication.translate("Dialog", u"Constrain Degrees of freedom setup", None))
        ...
        self.pushButton_unselect_all.setText(QCoreApplication.translate("Dialog", u"Unselect all", None))
        self.checkBox_constrain_rz.setText(QCoreApplication.translate("Dialog", u"Rotation Rz", None))
        self.checkBox_constrain_uy.setText(QCoreApplication.translate("Dialog", u"Displacement Uy", None))
        self.checkBox_constrain_uz.setText(QCoreApplication.translate("Dialog", u"Displacement Uz", None))
        self.checkBox_constrain_rx.setText(QCoreApplication.translate("Dialog", u"Rotation Rx", None))
        self.checkBox_constrain_ry.setText(QCoreApplication.translate("Dialog", u"Rotation Ry", None))
        self.checkBox_constrain_ux.setText(QCoreApplication.translate("Dialog", u"Displacement Ux", None))
...
class ConstrainedDofInputs_UI(QDialog, Ui_Dialog):
    """
    Component Hierarchy:
    - Dialog: QDialog
        - (Layout): QGridLayout
