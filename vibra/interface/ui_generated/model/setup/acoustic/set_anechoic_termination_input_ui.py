...
################################################################################
## Form generated from reading UI file 'set_anechoic_termination_input.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.treeWidget_anechoic_termination.setFont(font4)
...
class SetAnechoicTerminationInput_UI(QDialog, Ui_Dialog):
    """
    Component Hierarchy:
    - Dialog: QDialog
        - (Layout): QGridLayout
