...
################################################################################
## Form generated from reading UI file 'surface_velocity_input.ui'
##
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(QCoreApplication.translate("Dialog", u"Set surface velocity acoustic excitation", None))
...
class SurfaceVelocityInput_UI(QDialog, Ui_Dialog):
    """
    Component Hierarchy:
    - Dialog: QDialog
        - (Layout): QGridLayout
