...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.comboBox_compressor_type.setMinimumSize(QSize(180, 28))
        ...
        self.comboBox_connection_type.setMinimumSize(QSize(180, 28))
        ...
        self.comboBox_excitation_type.setMinimumSize(QSize(180, 28))
        ...
        self.lineEdit_table_path.setMinimumSize(QSize(300, 28))
