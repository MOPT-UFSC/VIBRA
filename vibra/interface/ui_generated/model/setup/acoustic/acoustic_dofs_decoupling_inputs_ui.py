...
################################################################################
## Form generated from reading UI file 'acoustic_dof_decoupling_inputs.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.treeWidget_dof_decoupling.setHeaderItem(__qtreewidgetitem)
    ...
    def retranslateUi(self, Dialog):
        ...
        ___qtreewidgetitem = self.treeWidget_dof_decoupling.headerItem()
...
#if QT_CONFIG(tooltip)
        self.treeWidget_dof_decoupling.setToolTip(QCoreApplication.translate("Dialog", u"Select a face to remove the previously attributed boundary condition.", None))
#endif // QT_CONFIG(tooltip)
...
class AcousticDofsDecouplingInputs_UI(QDialog, Ui_Dialog):
    """
    Component Hierarchy:
    - Dialog: QDialog
        - (Layout): QGridLayout
