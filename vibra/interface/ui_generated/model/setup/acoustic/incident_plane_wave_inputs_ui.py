...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.frame_wave_vector = QFrame(self.tab_constant_values)
        self.frame_wave_vector.setObjectName(u"frame_wave_vector")
        self.frame_wave_vector.setFrameShape(QFrame.NoFrame)
        self.frame_wave_vector.setFrameShadow(QFrame.Raised)
        self.gridLayout_10 = QGridLayout(self.frame_wave_vector)
        self.gridLayout_10.setObjectName(u"gridLayout_10")
        self.lineEdit_direction_z = QLineEdit(self.frame_wave_vector)
        self.lineEdit_direction_z.setObjectName(u"lineEdit_direction_z")
        self.lineEdit_direction_z.setMinimumSize(QSize(80, 28))
        self.lineEdit_direction_z.setMaximumSize(QSize(80, 28))
        self.lineEdit_direction_z.setFont(font2)
        self.lineEdit_direction_z.setStyleSheet(u"")
        self.lineEdit_direction_z.setAlignment(Qt.AlignCenter)

        self.gridLayout_10.addWidget(self.lineEdit_direction_z, 1, 4, 1, 1)

        self.lineEdit_direction_y = QLineEdit(self.frame_wave_vector)
        self.lineEdit_direction_y.setObjectName(u"lineEdit_direction_y")
        self.lineEdit_direction_y.setMinimumSize(QSize(80, 28))
        self.lineEdit_direction_y.setMaximumSize(QSize(80, 28))
        self.lineEdit_direction_y.setFont(font2)
        self.lineEdit_direction_y.setStyleSheet(u"")
        self.lineEdit_direction_y.setAlignment(Qt.AlignCenter)

        self.gridLayout_10.addWidget(self.lineEdit_direction_y, 1, 3, 1, 1)

        self.label_x_axis = QLabel(self.frame_wave_vector)
        self.label_x_axis.setObjectName(u"label_x_axis")
        self.label_x_axis.setMinimumSize(QSize(80, 26))
        self.label_x_axis.setMaximumSize(QSize(80, 26))
        self.label_x_axis.setFont(font2)
        self.label_x_axis.setAlignment(Qt.AlignCenter)

        self.gridLayout_10.addWidget(self.label_x_axis, 0, 2, 1, 1)

        self.label_z_axis = QLabel(self.frame_wave_vector)
        self.label_z_axis.setObjectName(u"label_z_axis")
        self.label_z_axis.setMinimumSize(QSize(80, 26))
        self.label_z_axis.setMaximumSize(QSize(80, 26))
        self.label_z_axis.setFont(font2)
        self.label_z_axis.setAlignment(Qt.AlignCenter)

        self.gridLayout_10.addWidget(self.label_z_axis, 0, 4, 1, 1)

        self.label_y_axis = QLabel(self.frame_wave_vector)
        self.label_y_axis.setObjectName(u"label_y_axis")
        self.label_y_axis.setMinimumSize(QSize(80, 26))
        self.label_y_axis.setMaximumSize(QSize(80, 26))
        self.label_y_axis.setFont(font2)
        self.label_y_axis.setAlignment(Qt.AlignCenter)

        self.gridLayout_10.addWidget(self.label_y_axis, 0, 3, 1, 1)

        self.lineEdit_direction_x = QLineEdit(self.frame_wave_vector)
        self.lineEdit_direction_x.setObjectName(u"lineEdit_direction_x")
        self.lineEdit_direction_x.setMinimumSize(QSize(80, 28))
        self.lineEdit_direction_x.setMaximumSize(QSize(80, 28))
        self.lineEdit_direction_x.setFont(font2)
        self.lineEdit_direction_x.setStyleSheet(u"")
        self.lineEdit_direction_x.setAlignment(Qt.AlignCenter)

        self.gridLayout_10.addWidget(self.lineEdit_direction_x, 1, 2, 1, 1)
        ...
        self.gridLayout_12.addWidget(self.frame_wave_vector, 3, 0, 1, 1)
        ...
        self.lineEdit_incident_pressure_imag.setMinimumSize(QSize(80, 28))
        self.lineEdit_incident_pressure_imag.setMaximumSize(QSize(80, 28))
        ...
        self.lineEdit_incident_pressure_real.setMinimumSize(QSize(80, 28))
        self.lineEdit_incident_pressure_real.setMaximumSize(QSize(80, 28))
        ...
        self.pushButton_load_table_x.setFont(font2)
        ...
        self.pushButton_load_table_y.setFont(font2)
        ...
        self.pushButton_load_table_z.setFont(font2)
        ...
        self.label_component_x_2.setFont(font2)
        ...
        self.label_component_x_4.setFont(font2)
        ...
        self.label_component_x_3.setFont(font2)
        ...
        QWidget.setTabOrder(self.lineEdit_incident_pressure_imag, self.lineEdit_direction_x)
        QWidget.setTabOrder(self.lineEdit_direction_x, self.lineEdit_direction_y)
        QWidget.setTabOrder(self.lineEdit_direction_y, self.lineEdit_direction_z)
        QWidget.setTabOrder(self.lineEdit_direction_z, self.pushButton_attribute)
        QWidget.setTabOrder(self.pushButton_attribute, self.pushButton_exit)
        QWidget.setTabOrder(self.pushButton_exit, self.pushButton_remove)
        ...
        QWidget.setTabOrder(self.treeWidget_incident_plane_wave, self.lineEdit_table_path_z)
        QWidget.setTabOrder(self.lineEdit_table_path_z, self.lineEdit_table_path_y)
        QWidget.setTabOrder(self.lineEdit_table_path_y, self.pushButton_load_table_z)
        QWidget.setTabOrder(self.pushButton_load_table_z, self.lineEdit_table_path_x)
        QWidget.setTabOrder(self.lineEdit_table_path_x, self.pushButton_load_table_x)
        QWidget.setTabOrder(self.pushButton_load_table_x, self.pushButton_load_table_y)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_x_axis.setText(QCoreApplication.translate("Dialog", u"x-axis", None))
        self.label_z_axis.setText(QCoreApplication.translate("Dialog", u"z-axis", None))
        self.label_y_axis.setText(QCoreApplication.translate("Dialog", u"y-axis", None))
        ...
        self.label_component_x.setText(QCoreApplication.translate("Dialog", u"Incident pressure:", None))
                                ...
                                - tab_constant_values: QWidget
                                    - (Layout): QGridLayout
                                            - frame_wave_vector: QFrame
                                                - (Layout): QGridLayout
                                                        - lineEdit_direction_z: QLineEdit
                                                        - lineEdit_direction_y: QLineEdit
                                                        - label_x_axis: QLabel
                                                        - label_z_axis: QLabel
                                                        - label_y_axis: QLabel
                                                        - lineEdit_direction_x: QLineEdit
