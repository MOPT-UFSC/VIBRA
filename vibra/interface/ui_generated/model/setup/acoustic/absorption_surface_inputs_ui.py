...
################################################################################
## Form generated from reading UI file 'absorption_surface_inputs.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_18.setMinimumSize(QSize(140, 28))
        self.label_18.setMaximumSize(QSize(140, 28))
        ...
        self.gridLayout_2.addWidget(self.pushButton_change_frequency_setup, 1, 3, 1, 1)
        ...
        self.treeWidget_absorption_surface = QTreeWidget(self.tab_list)
        __qtreewidgetitem = QTreeWidgetItem()
        __qtreewidgetitem.setTextAlignment(1, Qt.AlignCenter);
        __qtreewidgetitem.setTextAlignment(0, Qt.AlignCenter);
        self.treeWidget_absorption_surface.setHeaderItem(__qtreewidgetitem)
        self.treeWidget_absorption_surface.setObjectName(u"treeWidget_absorption_surface")
        self.treeWidget_absorption_surface.setMinimumSize(QSize(320, 100))
        self.treeWidget_absorption_surface.setMaximumSize(QSize(320, 200))
        font4 = QFont()
        font4.setFamilies([u"MS Shell Dlg 2"])
        font4.setPointSize(9)
        font4.setBold(False)
        font4.setItalic(False)
        self.treeWidget_absorption_surface.setFont(font4)
        self.treeWidget_absorption_surface.setIndentation(1)
        self.treeWidget_absorption_surface.setHeaderHidden(False)
        self.treeWidget_absorption_surface.header().setHighlightSections(False)
        self.treeWidget_absorption_surface.header().setProperty(u"showSortIndicator", False)
        self.treeWidget_absorption_surface.header().setStretchLastSection(True)

        self.gridLayout_9.addWidget(self.treeWidget_absorption_surface, 0, 0, 1, 1)
...
#if QT_CONFIG(tooltip)
        self.treeWidget_absorption_surface.setToolTip(QCoreApplication.translate("Dialog", u"Select a face to remove the previously attributed boundary condition.", None))
#endif // QT_CONFIG(tooltip)
        self.tabWidget_main.setTabText(self.tabWidget_main.indexOf(self.tab_list), QCoreApplication.translate("Dialog", u"List", None))
        self.label.setText(QCoreApplication.translate("Dialog", u"Absorption surface setup", None))
...
class AbsorptionSurfaceInputs_UI(QDialog, Ui_Dialog):
    """
    Component Hierarchy:
    - Dialog: QDialog
        - (Layout): QGridLayout
                            ...
                            - tabWidget_main: QTabWidget
                                ...
                                - tab_list: QWidget
                                    - (Layout): QGridLayout
                                            ...
                                            - treeWidget_absorption_surface: QTreeWidget
                - frame: QFrame
                    - (Layout): QGridLayout
                            - label: QLabel
                - frame_11: QFrame
