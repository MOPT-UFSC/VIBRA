...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 499, 540))
        ...
        self.pushButton_DB_equations.setFont(font2)
        icon = QIcon()
        ...
        self.doubleSpinBox_porous_material_depth.setFont(font2)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.comboBox_DBM_constants.setItemText(2, QCoreApplication.translate("Dialog", u"User-defined", None))

        self.tabWidget_main.setTabText(self.tabWidget_main.indexOf(self.tab_DBM), QCoreApplication.translate("Dialog", u"DBM models", None))
        ...
        self.tabWidget_main.setTabText(self.tabWidget_main.indexOf(self.tab_JCAL), QCoreApplication.translate("Dialog", u"JCAL models", None))
