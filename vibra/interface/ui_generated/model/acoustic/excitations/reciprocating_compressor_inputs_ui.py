...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(526, 742)
        Dialog.setMinimumSize(QSize(500, 500))
        Dialog.setMaximumSize(QSize(600, 1000))
        ...
        self.label_rod_diameter.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignTrailing|Qt.AlignmentFlag.AlignVCenter)
        ...
        self.label_head_end_clearance_unit.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        ...
        self.label_crank_end_clearance_unit.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        ...
        self.label_rod_diameter_unit.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        ...
        self.spinBox_valves_per_head.setFont(font4)
        self.spinBox_valves_per_head.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.frame_fluid_properties.setFrameShape(QFrame.Shape.NoFrame)
        ...
        self.label_data_type.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignTrailing|Qt.AlignmentFlag.AlignVCenter)
        ...
        self.lineEdit_export_path.setFont(font6)
        self.lineEdit_export_path.setFocusPolicy(Qt.FocusPolicy.StrongFocus)
        self.lineEdit_export_path.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.label_export_path.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignTrailing|Qt.AlignmentFlag.AlignVCenter)
        ...
        self.treeWidget_compressor_excitation.setFont(font5)
        self.treeWidget_compressor_excitation.setFrameShape(QFrame.Shape.StyledPanel)
        self.treeWidget_compressor_excitation.setFrameShadow(QFrame.Shadow.Sunken)
        ...
        QWidget.setTabOrder(self.pushButton_export_path, self.spinBox_number_of_points)
        ...
        QWidget.setTabOrder(self.lineEdit_number_of_revolutions, self.pushButton_process_aquisition_parameters)
        QWidget.setTabOrder(self.pushButton_process_aquisition_parameters, self.tabWidget_plots_2)
        QWidget.setTabOrder(self.tabWidget_plots_2, self.pushButton_plot_piston_position_and_velocity_time)
        QWidget.setTabOrder(self.pushButton_plot_piston_position_and_velocity_time, self.pushButton_plot_rod_pressure_load_time)
        QWidget.setTabOrder(self.pushButton_plot_rod_pressure_load_time, self.pushButton_plot_volumetric_flow_rate_at_discharge_time)
        ...
        QWidget.setTabOrder(self.pushButton_plot_volumetric_flow_rate_at_suction_time, self.pushButton_plot_pressure_head_end_angle)
        QWidget.setTabOrder(self.pushButton_plot_pressure_head_end_angle, self.pushButton_plot_volume_head_end_angle)
        QWidget.setTabOrder(self.pushButton_plot_volume_head_end_angle, self.pushButton_plot_volume_crank_end_angle)
        QWidget.setTabOrder(self.pushButton_plot_volume_crank_end_angle, self.pushButton_plot_pressure_crank_end_angle)
        QWidget.setTabOrder(self.pushButton_plot_pressure_crank_end_angle, self.pushButton_plot_volumetric_flow_rate_at_suction_frequency)
        QWidget.setTabOrder(self.pushButton_plot_volumetric_flow_rate_at_suction_frequency, self.pushButton_plot_volumetric_flow_rate_at_discharge_frequency)
        QWidget.setTabOrder(self.pushButton_plot_volumetric_flow_rate_at_discharge_frequency, self.pushButton_plot_rod_pressure_load_frequency)
        ...
        QWidget.setTabOrder(self.pushButton_remove, self.pushButton_reset_entries)
        QWidget.setTabOrder(self.pushButton_reset_entries, self.scrollArea)
