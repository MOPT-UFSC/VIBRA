...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lineEdit_right_value.setMaximumSize(QSize(120, 28))
        self.lineEdit_right_value.setFont(font3)
        ...
        self.lineEdit_left_value.setMaximumSize(QSize(120, 28))
        self.lineEdit_left_value.setFont(font3)
        ...
        self.label_unit.setMaximumSize(QSize(90, 28))
        self.label_unit.setFont(font3)
        ...
        self.gridLayout_3.addItem(self.horizontalSpacer_5, 2, 3, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_unit.setText(QCoreApplication.translate("Dialog", u"[Pa/m/s]", None))
