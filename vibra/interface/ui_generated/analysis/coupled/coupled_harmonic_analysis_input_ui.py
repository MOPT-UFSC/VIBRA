...
################################################################################
## Form generated from reading UI file 'coupled_harmonic_analysis_input.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label.setGeometry(QRect(38, 8, 325, 32))
        font1 = QFont()
    ...
    def retranslateUi(self, Dialog):
        ...
        self.comboBox.setToolTip(QCoreApplication.translate("Dialog", u"<html><head/><body><p align=\"center\"><br/></p></body></html>", None))
...
class CoupledHarmonicAnalysisInput_UI(QDialog, Ui_Dialog):
    """
    Component Hierarchy:
    - Dialog: QDialog
        - frame: QFrame
