...
#if QT_CONFIG(tooltip)
        self.comboBox_frequency_spacing.setToolTip(QCoreApplication.translate("Dialog", u"<html><head/><body><p align=\"center\">Select the analysis method</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
