...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout_9.addWidget(self.frame_buttons, 1, 0, 1, 1)

        self.tabWidget_main = QTabWidget(self.frame_2)
        self.tabWidget_main.setObjectName(u"tabWidget_main")
        self.tabWidget_main.setMinimumSize(QSize(0, 0))
        self.tabWidget_main.setMaximumSize(QSize(360, 16777215))
        font2 = QFont()
        ...
        self.lineEdit_fstep.setFont(font4)
        ...
        self.lineEdit_fmin.setFont(font4)
        ...
        self.lineEdit_fmax.setFont(font4)
        ...
        self.gridLayout_4.addWidget(self.frame_dampings, 1, 5, 1, 1)

        self.tabWidget_main.addTab(self.tab_damping, "")

        self.gridLayout_9.addWidget(self.tabWidget_main, 0, 0, 1, 1)
