...
################################################################################
## Form generated from reading UI file 'table_of_solution_steps.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout_3.addWidget(self.pushButton_run_analysis, 0, 0, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_run_analysis.setText(QCoreApplication.translate("Dialog", u"Exit", None))
    # retranslateUi



class TableOfSolutionSteps_UI(QDialog, Ui_Dialog):
    """
    Component Hierarchy:
    - Dialog: QDialog
        - (Layout): QGridLayout
