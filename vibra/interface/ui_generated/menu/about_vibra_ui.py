...
################################################################################
## Form generated from reading UI file 'about_vibra.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        sizePolicy.setHeightForWidth(self.label_main_info.sizePolicy().hasHeightForWidth())
        self.label_main_info.setSizePolicy(sizePolicy)
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QCoreApplication.translate("Dialog", u"About VIBRA", None))
        self.label_main_info.setText(QCoreApplication.translate("Dialog", u"Main_information", None))
        self.pushButton_repository.setText(QCoreApplication.translate("Dialog", u"Go to VIBRA repository", None))
        ...
        self.label_3.setText(QCoreApplication.translate("Dialog", u"Software for Vibration Analysis", None))
    # retranslateUi



class AboutVibra_UI(QDialog, Ui_Dialog):
    """
    Component Hierarchy:
    - Dialog: QDialog
        - (Layout): QGridLayout
