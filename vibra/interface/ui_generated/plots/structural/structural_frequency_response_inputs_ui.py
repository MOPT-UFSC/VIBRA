...
################################################################################
## Form generated from reading UI file 'structural_frequency_response_inputs.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.comboBox_structural_results.setMinimumSize(QSize(140, 28))
        self.comboBox_structural_results.setMaximumSize(QSize(140, 28))
        font4 = QFont()
        ...
        self.comboBox_dof_selector.setMinimumSize(QSize(140, 30))
        self.comboBox_dof_selector.setMaximumSize(QSize(140, 30))
    ...
    def retranslateUi(self, Form):
        ...
        self.label_linear.setText(QCoreApplication.translate("Form", u"Results format:", None))
...
class StructuralFrequencyResponseInputs_UI(QWidget, Ui_Form):
    """
    Component Hierarchy:
    - Form: QWidget
        - (Layout): QGridLayout
