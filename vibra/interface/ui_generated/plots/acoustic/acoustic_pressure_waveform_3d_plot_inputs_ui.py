...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 397, 575))
        ...
        self.gridLayout_13.addItem(self.horizontalSpacer, 4, 5, 1, 1)
        ...
        self.gridLayout_13.addWidget(self.lineEdit_animation_time, 4, 3, 1, 1)
        ...
        self.gridLayout_13.addWidget(self.label_animation_time, 4, 1, 1, 1)

        self.label_3 = QLabel(self.frame_4)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setMinimumSize(QSize(110, 26))
        self.label_3.setMaximumSize(QSize(110, 26))
        ...
        self.gridLayout_13.addWidget(self.comboBox_plot_type, 2, 3, 1, 1)
        ...
        self.gridLayout_13.addWidget(self.label_reduced_time, 3, 1, 1, 1)

        self.horizontalSpacer_14 = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.gridLayout_13.addItem(self.horizontalSpacer_14, 4, 0, 1, 1)
        ...
        self.gridLayout_13.addWidget(self.comboBox_reduced_time, 3, 3, 1, 1)
        ...
        self.gridLayout_13.addWidget(self.label_animation_time_unit, 4, 4, 1, 1)
