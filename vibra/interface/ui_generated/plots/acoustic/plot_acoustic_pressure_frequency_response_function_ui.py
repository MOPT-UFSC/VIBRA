...
################################################################################
## Form generated from reading UI file 'plot_acoustic_pressure_frequency_response_function.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lineEdit_output_selected_id.setMinimumSize(QSize(110, 30))
        self.lineEdit_output_selected_id.setMaximumSize(QSize(110, 30))
        font1 = QFont()
        ...
        self.comboBox_selector_filter.setFont(font4)
        ...
        self.lineEdit_input_selected_id.setMinimumSize(QSize(110, 30))
        self.lineEdit_input_selected_id.setMaximumSize(QSize(110, 30))
        self.lineEdit_input_selected_id.setFont(font4)
    ...
    def retranslateUi(self, Form):
        ...
        self.comboBox_selector_filter.setItemText(2, QCoreApplication.translate("Form", u"   Nodes", None))
...
class PlotAcousticPressureFrequencyResponseFunction_UI(QWidget, Ui_Form):
    """
    Component Hierarchy:
    - Form: QWidget
        - (Layout): QGridLayout
