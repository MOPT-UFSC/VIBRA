...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.comboBox_processing_selector.setMinimumSize(QSize(168, 30))
        self.comboBox_processing_selector.setMaximumSize(QSize(168, 30))
        font1 = QFont()
        ...
        self.gridLayout_6.addItem(self.horizontalSpacer_5, 1, 3, 1, 1)
        ...
        self.pushButton_flip_selection = QPushButton(self.frame_24)
        ...
        icon = QIcon()
        icon.addFile(u":/icons/invert_icon.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.lineEdit_input_surface_id.setMinimumSize(QSize(120, 30))
        self.lineEdit_input_surface_id.setMaximumSize(QSize(120, 30))
        font5 = QFont()
        ...
        self.pushButton_export_data = QPushButton(self.frame_18)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/save_as.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
