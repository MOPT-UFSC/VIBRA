...
################################################################################
## Form generated from reading UI file 'acoustic_waves_decomposition_inputs.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.setMaximumSize(QSize(16777215, 220))
        ...
        self.pushButton_flip_selection.setFont(font2)
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QCoreApplication.translate("Form", u"Plot the decomposed acoustic waves", None))
...
class AcousticWavesDecompositionInputs_UI(QWidget, Ui_Form):
    """
    Component Hierarchy:
    - Form: QWidget
        - (Layout): QGridLayout
