...
################################################################################
## Form generated from reading UI file 'plot_acoustic_pressure_frequency_response_input.ui'
##
...
class PlotAcousticPressureFrequencyResponseInput_UI(QWidget, Ui_Form):
    """
    Component Hierarchy:
    - Form: QWidget
        - (Layout): QGridLayout
