...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(424, 316)
        Form.setMinimumSize(QSize(0, 316))
        Form.setMaximumSize(QSize(16777215, 316))
        ...
        self.comboBox_normalized_impedance = QComboBox(self.frame_5)
        ...
        self.gridLayout_6.addWidget(self.comboBox_normalized_impedance, 4, 2, 1, 1)
