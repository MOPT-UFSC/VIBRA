...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(424, 372)
        Form.setMinimumSize(QSize(0, 372))
        Form.setMaximumSize(QSize(16777215, 372))
        ...
        self.frame_volume_selector.setFrameShape(QFrame.Shape.NoFrame)
        self.frame_volume_selector.setFrameShadow(QFrame.Shadow.Raised)
        ...
        self.frame_8 = QFrame(self.frame_volume_selector)
        ...
        self.gridLayout_3.addWidget(self.frame_volume_selector, 3, 0, 1, 1)
        ...
        self.frame_normalized_impedance.setFrameShape(QFrame.Shape.NoFrame)
        self.frame_normalized_impedance.setFrameShadow(QFrame.Shadow.Raised)
