...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButton_cancel = QPushButton(self.frame_6)
        self.pushButton_cancel.setObjectName(u"pushButton_cancel")
        self.pushButton_cancel.setMinimumSize(QSize(100, 28))
        self.pushButton_cancel.setMaximumSize(QSize(100, 28))
        ...
        QWidget.setTabOrder(self.pushButton_invert, self.pushButton_cancel)
