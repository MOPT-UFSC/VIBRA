...
# Form implementation generated from reading ui file 'general/print_messages2.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.pushButton_close.setStyleSheet("QPushButton{border-radius: 16px; border-color: rgb(150, 150, 150); border-style: ridge; border-width: 2px; color: rgb(0, 0, 0); background-color: rgb(240, 240, 240); font: 75 bold 12pt \"MS Shell Dlg 2\"}\n"
...
"QPushButton:pressed{border-radius: 16px; border-color: rgb(0, 170, 255); border-style: ridge; border-width: 3px; color: rgb(0, 0, 0); background-color: rgb(174, 213, 255); font: 75 bold 12pt \"MS Shell Dlg 2\"}")
        ...
        self.frame_title.setMaximumSize(QtCore.QSize(650, 48))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_message.setText(_translate("Dialog", "Print message..."))
        self.label_title.setText(_translate("Dialog", "Title"))


class PrintMessages2_UI(QtWidgets.QDialog, Ui_Dialog):
    """
    Component Hierarchy:
    - Dialog: QDialog
        - (Layout): QGridLayout
